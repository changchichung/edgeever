---
draft: false
title: "從 Notion 遷移到 EdgeEver 指南"
snippet: "利用雙 MCP 服務器聯動，讓 AI 助手自動將 Notion 頁面批量導入到 EdgeEver。"
image: {
    src: "/images/notion-migration.jpg",
    alt: "從 Notion 遷移到 EdgeEver"
}
...
```text
你是我的 AI 助手。現在你同時連接了我的 Notion MCP 服務 and 新 EdgeEver MCP 服務。
